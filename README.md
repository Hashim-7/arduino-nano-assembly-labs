...
Assemble the .s files in src/ to generate the .hex files in build/ using your preferred AVR assembler.

Upload the .hex files to the Arduino Nano using avrdude or the Arduino IDE.

Observe the corresponding LED outputs as described for each program.
